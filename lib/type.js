...
export function isPlainObject(v) {
  // I added v.length condition because arguments has length property.
...
/**
 * This function evaluate whether arguments is json plain object string
 * @param {*} v
 * @returns {boolean}
 * @memberof type
 * @example
 * isJSONPlainObjectString('{ "x": 1 }');
 */
...
/**
 * This function evaluate whether arguments is json array stirng
 * @param {*} v
 * @returns {boolean}
 * @memberof type
 * @example
...
/**
 * This function evaluate whether arguments is json plain object string or json array string
 * @param {*} v
 * @returns {boolean}
 * @memberof type
 * @example
 * isJSONObjectString('{ "x": 1 }');
 */
